                ...
                <span>
                    <template v-if="$parent.fConfigs.isDateRange">
                        <span
                            ...
                            >{{
                                $parent.calendar.dateRange.start.dateTime
                            }}</span
                        >
                        <template v-if="$parent.calendar.dateRange.end.date">
                            ...
                            <span
                                ...
                                :class="{ 'vfc-active': !startDateActive }"
                                >{{
                                    $parent.calendar.dateRange.end.dateTime
                                }}</span
                            >
                        </template>
                    </template>
                    <template
                        v-else-if="$parent.fConfigs.isMultipleDatePicker"
                        >{{ getCurrentDateTime }}</template
                    >
                    <template v-else>{{
            ...
            <div class="vfc-time-picker">
                ...
                >
                    <div
                        ...
                        :class="{
                            'vfc-time-picker__item--selected': checkHourActiveClass(
                                i
                            ),
                        }"
                        v-for="i in 24"
                ...
                >
                    <div
                        class="vfc-time-picker__item"
                        :class="{
                            'vfc-time-picker__item--selected': checkMinuteActiveClass(
                                i
                            ),
                        }"
                        v-for="i in 60"
